            ...
            tr.innerHTML = `
                ...
                <td>
                    <div class="btn-group-vertical">
                            <button class="btn btn-warning btn-sm" onclick="editFlower(${cursor.value.id}, '${cursor.value.flowerName}', ${cursor.value.packageQuantity}, '${cursor.value.description}', '${cursor.value.dateTime}')">Editar</button> <br> 

                            <button class="btn btn-danger btn-sm" onclick="confirmDelete(${cursor.value.id})">Eliminar</button>
                        </div>
                    </td>
                `;
